      ...
      <div className={`card-inner ${isFlipped ? "flipped" : ""}`}>
        <div className="card-front flex-col">
          ...
          <div className="flex justify-between w-full px-8 py-2">
            <div className="font-light text-sm bg-yellow-100 rounded-md px-3 py-1 text-yellow-700">
              {difficulty}
            </div>
            <div className="font-light text-sm bg-yellow-100 rounded-md px-3 py-1 text-yellow-700">
              {category}
          ...
          <div className="text-xl font-semibold h-full flex items-center overflow-auto">
            {question}
          </div>
